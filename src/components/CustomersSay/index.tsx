    ...
    <Container {...props}>
      ...
      <Cards>
        ...
        <CustomersSayCard
          ...
          customerName="Bruno"
          testimonial="I have been to many restaurants, but this one certainly stood out. The quality of the ingredients and the preparation of the dishes were impeccable."
        />
        <CustomersSayCard
          rating={5}
